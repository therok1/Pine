...
namespace Pine
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.TextVertexArray->SetIndexBuffer(indexBuffer);
	...
	void Renderer2D::Flush()
	{
		...
		{
			uint32_t dataSize = static_cast<uint32_t>(reinterpret_cast<uint8_t*>(s_Data.TextVertexBufferPtr) - reinterpret_cast<uint8_t*>(s_Data.TextVertexBufferBase));
