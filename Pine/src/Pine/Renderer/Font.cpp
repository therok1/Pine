...
namespace Pine 
{
		...
		: m_Data(new MSDFData())
	{
		...
		if (!font)
		{
			PN_CORE_ERROR("Failed to load font: {}", fileString);
			return;
		}
		...
		PN_CORE_INFO("Loaded {} glyphs from font (out of {})", glyphsLoaded, charset.size());
...
#define THREAD_COUNT 8
	...
	Ref<Font> Font::GetDefault()
	{
		...
		if (!DefaultFont)
			DefaultFont = CreateRef<Font>("assets/fonts/open_sans/OpenSans-Regular.ttf");
