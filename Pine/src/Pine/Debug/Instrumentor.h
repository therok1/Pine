...
#define PN_PROFILE 0
	...
	#define PN_PROFILE_BEGIN_SESSION(name, filepath) ::Pine::Instrumentor::Get().BeginSession(name, filepath)
	#define PN_PROFILE_END_SESSION() ::Pine::Instrumentor::Get().EndSession()
	#define PN_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Pine::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
												   ::Pine::InstrumentationTimer timer##line(fixedName##line.Data)
	#define PN_PROFILE_SCOPE_LINE(name, line) PN_PROFILE_SCOPE_LINE2(name, line)
